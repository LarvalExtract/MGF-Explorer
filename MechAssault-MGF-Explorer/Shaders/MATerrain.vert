...
void main()
{
	...
	worldPosition = vec3(modelMatrix * vec4(vertexPosition.x, vertexPosition.y + heightValue * 8, vertexPosition.z, 1.0));
	//worldPosition.y = clamp(worldPosition.y, minHeight, maxHeight);
