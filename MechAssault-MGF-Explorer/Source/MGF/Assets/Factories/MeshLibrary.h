...
namespace MA
{
	...
	private:
		Qt3DRender::QGeometryRenderer* CreateMesh(const MGFFile& verticesFile, const MGFFile& indicesFile, const std::string_view material, const MGFFile& sourceFile, Qt3DRender::QGeometryRenderer::PrimitiveType primitiveType);
